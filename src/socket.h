...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(rleavrs::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(rleavrs::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(rleavrs::Address::ptr address);
